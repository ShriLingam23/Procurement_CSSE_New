...
%>
            <form action="EditUserHandler" class="templatemo-login-form" method="POST">
              ...
              <div class="row form-group">
                <div class="col-lg-6 col-md-6 form-group">                  
                    ...
                    <input type="text" class="form-control" id="password" name="password" value="<%=resultSet.getString("password") %>">                  
                </div>
                <div class="col-lg-6 col-md-6 form-group">                  
                    <label for="inputConfirmNewPassword">Confirm Password</label>
                    <input type="text" class="form-control" id="cpassword" name="cpassword" value="<%=resultSet.getString("cpassword") %>"> 
                </div> 
              </div>
              <div class="row form-group">
              	 <div class="col-lg-6 col-md-6 form-group">                  
                ...
                <div class="col-lg-6 col-md-6 form-group">                  
                    ...
                    <select class="form-control" id="role" name="role">
                      <option> <%=resultSet.getString("role") %>  </option>
				      <option>Admin</option>
