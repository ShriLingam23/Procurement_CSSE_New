              ...
              <table class="table table-striped table-bordered templatemo-user-table">
                <thead>
                  <tr>
                    ...
                    <td><a href="" class="white-text templatemo-sort-by">Material Type <span class="caret"></span></a></td>
...
%>
                  <tr>
                    ...
                    <td><a href="SupplierEdit.jsp?id=<%=resultSet.getString("supplier")%>" class="templatemo-edit-btn">Edit</a></td>
                    <td><a href="DeleteSupplierHandler?id=<%=resultSet.getString("supid")%>" class="templatemo-edit-btn">Delete</a></td>
