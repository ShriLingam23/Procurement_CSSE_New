...
%>
                  <tr>
                    ...
                    <td><%=resultSet.getString("price") %></td>
                   	<td><a href="MaterialEdit.jsp?id=<%=resultSet.getString("material")%>" class="templatemo-edit-btn">Edit</a></td>
                    <td><a href="DeleteMaterialHandler?id=<%=resultSet.getString("mid")%>" class="templatemo-edit-btn">Delete</a></td>
