              ...
              <table class="table table-striped table-bordered templatemo-user-table">
                <thead>
                  <tr>
                    ...
                    <td><a href="" class="white-text templatemo-sort-by">Budget <span class="caret"></span></a></td>
                    <td><a href="" class="white-text templatemo-sort-by">Contact <span class="caret"></span></a></td>
                    <td><a href="" class="white-text templatemo-sort-by">Start Date <span class="caret"></span></a></td>
                    <td><a href="" class="white-text templatemo-sort-by">End Date <span class="caret"></span></a></td>
                    <td>Edit</td>
                    <td>Delete</td>
                  </tr>
                </thead>
...
%>
                  <tr>
                    ...
                    <td><a href="SiteEdit.jsp?id=<%=resultSet.getString("client")%>" class="templatemo-edit-btn">Edit</a></td>
                    <td><a href="DeleteSiteHandler?id=<%=resultSet.getString("sid")%>" class="templatemo-edit-btn">Delete</a></td>
