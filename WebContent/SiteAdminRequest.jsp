      ...
      <div class="templatemo-content col-1 light-gray-bg">
        ...
        <div class="templatemo-content-container">
          <div class="templatemo-content-widget white-bg">
           		...
           		<a class="btn btn-primary btn-lg btn-block" href="Request.jsp">Add</a>
				<a type="button" class="btn btn-secondary btn-lg btn-block" href="SiteManagerRequestView.jsp">View</a>
        </div>
      </div>
    </div>
