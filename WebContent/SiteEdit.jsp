			...
			try{
					Connection con = DbConnection.getDBConnection(); 
	 		        Statement myStm= con.createStatement();
	 		       	String query  ="SELECT * FROM site WHERE client='"+id+"'";
...
%>
            <form action="EditSiteHandler" class="templatemo-login-form" method="POST">
              <div class="row form-group">
                <div class="col-lg-6 col-md-6 form-group">                  
                    <label for="inputFirstName">Client</label>
                    <input type="text" class="form-control" id=client name="client"  value="<%=resultSet.getString("client") %>">                  
                </div>
                <div class="col-lg-6 col-md-6 form-group">                  
                    <label for="inputLastName">Location</label>
                    <select class="form-control" id="location" name="location">
                      <option><%=resultSet.getString("location") %></option>
              ...
              <div class="row form-group">
                <div class="col-lg-6 col-md-6 form-group">                  
                    ...
                    <input type="text" class="form-control" id="budget" name="budget" value="<%=resultSet.getString("budget") %>">                  
                </div>
                <div class="col-lg-6 col-md-6 form-group">                  
                    <label for="inputConfirmNewPassword">Contact No</label>
                    <input type="text" class="form-control" id="contact" name="contact" value="<%=resultSet.getString("contact") %>"> 
                </div> 
              </div>
              <div class="row form-group">
              	 <div class="col-lg-6 col-md-6 form-group">                  
                    <label for="inputEmail">Start Date</label>
                    <input type="date" class="form-control" id="sdate" name="sdate" value="<%=resultSet.getString("sdate") %>">                  
                </div> 
                <div class="col-lg-6 col-md-6 form-group">                  
                    <label for="inputNewPassword">End Date</label>
                    <input type="date" class="form-control" id="edate" name="edate" value="<%=resultSet.getString("edate") %>">  
                </div>
