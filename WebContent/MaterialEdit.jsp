      ...
      <div class="templatemo-content col-1 light-gray-bg">
        ...
        <div class="templatemo-content-container">
          <div class="templatemo-content-widget white-bg">
            <h2 class="margin-bottom-10 text-center">Material</h2>
            <br></>
            <%
			...
			try{
					Connection con = DbConnection.getDBConnection(); 
	 		        Statement myStm= con.createStatement();
	 		       	String query  ="SELECT * FROM material WHERE material='"+id+"'";
...
%>
            <form action="EditMaterialHandler" class="templatemo-login-form" method="POST">
              <div class="row form-group">
                <div class="col-lg-6 col-md-6 form-group">                  
                    <label for="inputLastName">Material</label>
              ...
              <div class="row form-group">
                <div class="col-lg-6 col-md-6 form-group">                  
                    ...
                    <select class="form-control" id="qty" name="qty">
				      <option><%=resultSet.getString("quantity") %></option>
				      <option>100</option>
				      <option>150</option>
				      <option>200</option>
				      <option>250</option>
                ...
                <div class="col-lg-6 col-md-6 form-group">                  
                    <label for="inputConfirmNewPassword">Price per unit</label>
