      ...
      <div class="templatemo-content col-1 light-gray-bg">
        ...
        <div class="templatemo-content-container">
          <div class="templatemo-content-widget white-bg">
            <h2 class="margin-bottom-10 text-center">Supplier</h2>
            </br></br>
            <form action="SupplierHandler" class="templatemo-login-form" method="POST">
              ...
              <div class="row form-group">
                <div class="col-lg-6 col-md-6 form-group">                  
                    ...
                    <input type="text" class="form-control" id="mobile" name="mobile"  placeholder="Enter the Mobile">                  
                </div> 
                <div class="col-lg-6 col-md-6 form-group">                  
