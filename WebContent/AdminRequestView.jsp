...
<body>
	...
	<div class="templatemo-flex-row">
		...
		<div class="templatemo-content col-1 light-gray-bg">
			...
			<h2 style="margin-bottom: 20px;margin-top: 30px;margin-left:250px;color:#E98B3A  "><strong><b>Procurement Requests In Progress</b></strong></h2>
						...
						<table
							...
							<thead>
								<tr>
									...
									<td><a href="" class="white-text templatemo-sort-by">Location
											<span class="caret"></span>
									</a></td>
									<td><a href="" class="white-text templatemo-sort-by">Request
											Date <span class="caret"></span>
									</a></td>
									<td><a href="" class="white-text templatemo-sort-by">Quantity
											<span class="caret"></span>
									</a></td>
									...
									<td><a href="" class="white-text templatemo-sort-by">Received
											Quantity<span class="caret"></span>
									</a></td>
									<td><a href="" class="white-text templatemo-sort-by">Supplier<span
											class="caret"></span></a></td>
									<td><a href="" class="white-text templatemo-sort-by">Payment<span
											class="caret"></span></a></td>
									<td>Edit</td>
								</tr>
							</thead>
        ...
        try {
             ...
             String query = "select * from request WHERE payment !='Paid'";
...
%>
							<tr>
								...
								<%
								if(!(resultSet.getString("odate")==null)){
								%>
								<td><%=resultSet.getString("odate") %></td>
								<td><%=resultSet.getString("uprice") %></td>
								<td><%=resultSet.getString("rqty") %></td>
								<td><%=resultSet.getString("supplier") %></td>
								<%
								}else{
								%>
								<td style="background-color:#898685;color:#ECEBEB ">To be Reviewed</td>
								<td style="background-color:#898685;color:#ECEBEB ">To be Reviewed</td>
								<td style="background-color:#898685;color:#ECEBEB ">To be Reviewed</td>
								<td style="background-color:#898685;color:#ECEBEB ">To be Reviewed</td>
								<%
				    ...
				    %>
								<td><a
									href="AdminRequestEdit.jsp?id=<%=resultSet.getString("rid")%>"
									class="templatemo-edit-btn">Review</a></td>
								<% } 
				        else if ("Delivered".equals(resultSet.getString("status"))) {
				        		if ("Pending".equals(resultSet.getString("payment"))){ 			
				    %>
								<td><a href="EditAdmitRequestHandler?id=<%=resultSet.getString("rid")%>" class="templatemo-edit-btn">Pay</a></td>

								<% } 
				        else {
				    %>
								<td style="background-color: #3AEF7C;">Transaction Completed</td>
								<% 
				        }
				        		}
						    ...
						    %>
								<td style="background-color: #DF4222;">Order Placed</td>
								<% 
						        }
...
%>
					...
					<!-- Table 2 -->
					<h2 style="margin-bottom: 20px;margin-top: 30px;margin-left:250px;color: #429435 "><strong><b>Completed Procurement Requests</b></strong></h2>
