              ...
              <table class="table table-striped table-bordered templatemo-user-table">
                <thead>
                  <tr>
                    ...
                    <td><a href="" class="white-text templatemo-sort-by">Unit Price <span class="caret"></span></a></td>
                    <td><a href="" class="white-text templatemo-sort-by">Received Quantity<span class="caret"></span></a></td>
                    <td><a href="" class="white-text templatemo-sort-by">Supplier<span class="caret"></span></a></td>
                    <td><a href="" class="white-text templatemo-sort-by">Payment<span class="caret"></span></a></td>
                    <td>Edit</td>
                  </tr>
                </thead>
               <%
...
%>
                  <tr>
				    ...
				    %>
                    <td><a href="AdminRequestEdit.jsp?id=<%=resultSet.getString("rid")%>" class="templatemo-edit-btn">Accept</a></td>
                    <% } 
				        else if ("Delivered".equals(resultSet.getString("status"))) {
				        		if ("Pending".equals(resultSet.getString("payment"))){ 			
				    %>  
				    <td><a href="" class="templatemo-edit-btn">Pay</a></td>  
					
					<% } 
				        else {
				    %>    
					<td><a href="DeleteAdminRequestHandler?id=<%=resultSet.getString("rid")%>" class="templatemo-edit-btn">Delete</a></td>
				    <% }
				        }
				    %>
